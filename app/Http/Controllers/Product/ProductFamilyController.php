...
class ProductFamilyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $result = VlProductFamilia::orWhere('identity','LIKE',$q)
    ...
    public function show(string $id)
    {
        ...
        $result = VlProductFamilia::all();
        $filename = app(VlProductFamilia::class)->getTable() . date("_Ymd_His");
    ...
    public function edit(string $id)
    {
        ...
        $row = VlProductFamilia::whereToken($id)->first();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $l->tablename   = app(VlProductFamilia::class)->getTable();
        $l->data_before = $row;
        $l->record_id   = $row->id;
        /* Datos */
        $row->fill($request->all());
