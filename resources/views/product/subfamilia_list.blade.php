...
@section('breadcrumb')
    <div class="content-header pb-0">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="fas fa-cubes fa-fw"></i> Sub-Familia</h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-5 mt-2">
                    <form action="{{ route('subfamilia.index') }}" method="GET">
                        ...
                        <div class="btn-toolbar" role="toolbar">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <a href="{{ route('subfamilia.create') }}" class="btn btn-success">
                                        <i class="far fa-plus-square fa-fw"></i>
                                        <span class="d-md-inline-block d-none">NUEVO</span>
                                    </a>
                                    <a href="{{ route('subfamilia.show','download') }}" class="btn btn-outline-success">
                        ...
                        <tr id="tr-{{ $item->id }}">
							...
							<td class="text-right text-nowrap">
                                @if($item->id == 1)
                                    ...
                                    <i class="fas fa-lock"></i>
                                @else
                                    <a href="{{ route('subfamilia.edit',$item->token) }}">
                                        <i class="far fa-edit"></i>
                                    </a> |
                                    <a href="#" class="delete-record" data-id="{{ $item->id }}" data-url="{{ route('subfamilia.destroy',$item->token) }}">
