            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('um.index') }}">Unidad de Medida</a></li>
            ...
            <div class="card-body bg-form">
                <div class="row mb-2">
                    <div class="col-md-7">
                        ...
                        <input type="text" class="form-control" name="umname" id="umname"
                            value="{{ old('umname', $row->umname) }}" required />
                    </div>
                    <div class="col-md-3">
                        <label class="mb-0">Abreviado</label>
                        <input type="text" class="form-control" name="shortname" id="shortname"
                            value="{{ old('shortname', $row->shortname) }}" required />
                    </div>
                    <div class="col-md-2">
